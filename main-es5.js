...
(window["webpackJsonp"] = window["webpackJsonp"] || []).push([["main"], {
  ...
  function srcAppAppModuleTs(module, __webpack_exports__, __webpack_require__) {
    ...
    var _pipe_amount_pipe__WEBPACK_IMPORTED_MODULE_9__ = __webpack_require__(
    /*! ./pipe/amount.pipe */
    ...
    */
    ...
    (function () {
      (typeof ngJitMode === "undefined" || ngJitMode) && _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵsetNgModuleScope"](AppModule, {
        declarations: [_app_component__WEBPACK_IMPORTED_MODULE_5__["AppComponent"], _components_ccaachart_ccaachart_component__WEBPACK_IMPORTED_MODULE_6__["CCAAchartComponent"], _pipe_amount_pipe__WEBPACK_IMPORTED_MODULE_9__["Amount"]],
        imports: [_angular_platform_browser__WEBPACK_IMPORTED_MODULE_0__["BrowserModule"], _app_routing_module__WEBPACK_IMPORTED_MODULE_4__["AppRoutingModule"], _angular_platform_browser_animations__WEBPACK_IMPORTED_MODULE_7__["BrowserAnimationsModule"], _angular_common__WEBPACK_IMPORTED_MODULE_2__["CommonModule"], _angular_forms__WEBPACK_IMPORTED_MODULE_8__["ReactiveFormsModule"], _angular_forms__WEBPACK_IMPORTED_MODULE_8__["FormsModule"], _angular_common_http__WEBPACK_IMPORTED_MODULE_3__["HttpClientModule"]]
      });
    })();
    /*@__PURE__*/
  ...
  function srcAppComponentsCcaachartCcaachartComponentTs(module, __webpack_exports__, __webpack_require__) {
    ...
    var _pipe_amount_pipe__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(
    /*! ../../pipe/amount.pipe */
    "./src/app/pipe/amount.pipe.ts");
    ...
    function CCAAchartComponent_option_142_Template(rf, ctx) {
      if (rf & 1) {
      ...
      _createClass(CCAAchartComponent, [{
        ...
        value: function getSpainCSV() {
          ...
          this.http.get(localUrl, {
            ...
            _this.drawPie(_this.jsonResumeSpain);
          });
        } //get fulll CSV
        ...
        value: function getRegionsCSV() {
          ...
          this.http.get(localUrl, {
            ...
            var source1 = _toConsumableArray(regionsCSV.sort(dynamicSortMultiple(['Acumulados', 'CCAA', 'Ultimas 24h', 'Incidencia']))); //console.log("source1",source1)
            ...
            var source2 = _toConsumableArray(regionsCSV.sort(dynamicSortMultiple(['Ultimas 24h', 'CCAA', 'Acumulados', 'Incidencia']))); //console.log("source2",source2)
            ...
            var source3 = _toConsumableArray(regionsCSV.sort(dynamicSortMultiple(['Incidencia', 'CCAA', 'Ultimas 24h', 'Acumulados']))); //console.log("source3",source3)
            ...
            _this3.plotGraphE3(data3); //now build the other


            _this3.getPopulationCSV(data1, data2, data3);
          });
        } //get population comunidades csv

      }, {
        key: "getPopulationCSV",
        value: function getPopulationCSV(data1, data2, data3) {
          var _this4 = this;
          ...
          this.http.get(localUrl, {
            ...
            //console.log("----CSV ",data);
            var populationCSV = _this4.csvToJSON(data); //console.log("---populationCSV",populationCSV)
            ...
            var _loop = function _loop(i) {
              populationCSV.forEach(function (item_B) {
                if (data4.ccaa[i] === item_B.CCAA) {
                  ...
                  data4.ccaahab[i] = item_B.CCAA + '(' + populationClean + ' hab)'; //console.log(data4.ccaa[i], item_B.CCAA, data4.acumulados[i])
                }
              });
            };

            for (var i = 0; i < data4.ccaa.length; i++) {
              _loop(i);
            }
            ...
            var _loop2 = function _loop2(_i) {
              populationCSV.forEach(function (item_B) {
                if (data5.ccaa[_i] === item_B.CCAA) {
                  var relative = data5.ultimas[_i] / item_B.population * 1000;
                  data5.ultimas[_i] = relative.toFixed(2);
                  var populationClean = new Intl.NumberFormat('de-DE').format(item_B.population);
                  data5.ccaahab[_i] = item_B.CCAA + '(' + populationClean + ' hab)'; //console.log(data5.ccaa[i], item_B.CCAA, data5.ultimas[i])
                }
              });
            };

            for (var _i = 0; _i < data5.ccaa.length; _i++) {
              _loop2(_i);
            }
            ...
            var _loop3 = function _loop3(_i2) {
              populationCSV.forEach(function (item_B) {
                if (data6.ccaa[_i2] === item_B.CCAA) {
                  var relative = data6.incidencia[_i2] / item_B.population * 1000;
                  data6.incidencia[_i2] = relative.toFixed(2);
                  var populationClean = new Intl.NumberFormat('de-DE').format(item_B.population);
                  data6.ccaahab[_i2] = item_B.CCAA + '(' + populationClean + ' hab)'; //console.log(data6.ccaa[i], item_B.CCAA, data6.incidencia[i])
                }
              });
            };

            for (var _i2 = 0; _i2 < data6.ccaa.length; _i2++) {
              _loop3(_i2);
            }
            ...
            _this4.plotGraphE4(data4);

            _this4.plotGraphE5(data5);

            _this4.plotGraphE6(data6);
          });
        } //--AUX functions
        ...
        value: function csvToJSON(csv) {
          var lines = csv.split("\n");
          var result = [];
          var headers = lines[0].split(","); //console.log("headers",headers)
        ...
        key: "massageSpainData",
        value: function massageSpainData() {
          ...
          var collectedData = []; //console.log("groupedByDate", groupedByDate.length ,groupedByDate);
          //loop to calculate by Date

          for (var property in groupedByDate) {
          ...
          this.spainDataFull.fechas = collectedData.map(function (item) {
            return item.fecha;
          });
          this.spainDataFull.casos = collectedData.map(function (item) {
            return item.casos != "" ? item.casos : 0;
          });
          this.spainDataFull.hospitalizados = collectedData.map(function (item) {
            return item.hospitalizados != "" ? item.hospitalizados : 0;
          });
          this.spainDataFull.uci = collectedData.map(function (item) {
            return item.uci != "" ? item.uci : 0;
          });
          this.spainDataFull.fallecidos = collectedData.map(function (item) {
            return item.fallecidos != "" ? item.fallecidos : 0;
          });
          this.spainDataFull.Recuperados = collectedData.map(function (item) {
            return item.recuperados != "" ? item.recuperados : 0;
          ...
          console.log("this.spainDataFull---", this.spainDataFull); //need to order this values
        ...
        value: function massageData(ccaacode, mode) {
          ...
          this.madridData = cleanDataOneCCAA; //console.log("clean data massageData",this.madridData)
          ...
          this.madridDataFull.Recuperados = this.madridData.map(function (item) {
            return item['Recuperados'] != "" ? item['Recuperados'] : 0;
          }); //calculate Casos por dia
        ...
        key: "setCCAAMode",
        value: function setCCAAMode(value) {
        ...
        key: "plotGraphCUpdate",
        value: function plotGraphCUpdate() {
          var enfermos = this.comunidadSelecccionadaKPIS.casos - this.comunidadSelecccionadaKPIS.recuperados - this.comunidadSelecccionadaKPIS.fallecidos;
        ...
        key: "plotGraphE4",
        value: function plotGraphE4(data) {
        ...
        key: "plotGraphE5",
        value: function plotGraphE5(data) {
        ...
        key: "plotGraphE6",
        value: function plotGraphE6(data) {
    ...
    CCAAchartComponent.ɵcmp = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdefineComponent"]({
      ...
      template: function CCAAchartComponent_Template(rf, ctx) {
        if (rf & 1) {
          ...
          _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵtext"](5, "Situaci\xF3n actual de Espa\xF1a");
          ...
          _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵtext"](10, "Espa\xF1a");
          ...
          _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵtext"](23, "Casos \xFAltimas 24H");
          ...
          _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵtext"](73, " se muestran solo los \xFAltimos 30 d\xEDas");

          _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelementEnd"]();

          _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelementStart"](74, "p", 12);

          _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵtext"](75, " Las gr\xE1ficas azul y naranaja siempre suben, por que suma los datos, cuando se aplanen ser\xE1 que deja de haber casos");

          _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelementEnd"]();

          _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelementStart"](76, "p", 12);

          _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵtext"](77, " Las gr\xE1ficas verde y roja iran cayendo en pendiente si se vacian hospitales y UCIS");
          ...
          _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵtext"](82, "COVID 19: valores por d\xEDa ( ver nota **)");
          ...
          _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵtext"](86, " se muestran solo los \xFAltimos 30 d\xEDas");

          _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelementEnd"]();

          _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelementStart"](87, "p", 12);

          _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵtext"](88, " Estas gr\xE1ficas suben y bajan, por que son los casos totales de cada d\xEDa");

          _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelementEnd"]();

          _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelementStart"](89, "p", 12);

          _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵtext"](90, " Lo que hay que fijarse es si las columnas van bajando seg\xFAn pasan los d\xEDas, lo cual indicar\xEDa una mejora");
          ...
          _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵtext"](95, "Comparanci\xF3n de comunidades");
          ...
          _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵtext"](112, "Casos en los \xFAtimos 14 d\xEDas");
          ...
          _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵtext"](131, "Casos en los \xFAtimos 14 d\xEDas por cada 1.000 habitantes");
          ...
          _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵlistener"]("ngModelChange", function CCAAchartComponent_Template_select_ngModelChange_141_listener($event) {
          ...
          _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵtext"](210, " se muestran solo los \xFAltimos 30 d\xEDas");

          _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelementEnd"]();

          _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelementStart"](211, "p", 12);

          _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵtext"](212, " Las gr\xE1ficas azul y naranaja siempre suben, por que suma los datos, cuando se aplanen ser\xE1 que deja de haber casos");

          _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelementEnd"]();

          _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelementStart"](213, "p", 12);

          _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵtext"](214, " Las gr\xE1ficas verde y roja iran cayendo en pendiente si se vacian hospitales y UCIS");
          ...
          _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵtext"](219, "COVID 19: valores por d\xEDa ( ver nota **)");
          ...
          _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵtext"](223, " se muestran solo los \xFAltimos 30 d\xEDas");

          _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelementEnd"]();

          _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelementStart"](224, "p", 12);

          _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵtext"](225, " Estas gr\xE1ficas suben y bajan, por que son los casos totales de cada d\xEDa");

          _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelementEnd"]();

          _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelementStart"](226, "p", 12);

          _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵtext"](227, " Lo que hay que fijarse es si las columnas van bajando seg\xFAn pasan los d\xEDas, lo cual indicar\xEDa una mejora");
          ...
          _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵtext"](244, " estas gr\xE1ficas usan los datos oficiales compartidos por el gobierno a la poblaci\xF3n. Seg\xFAn el rigor con que se han tomado esos datos, las gr\xE1ficas por d\xEDas debe tomarse como una aproximaci\xF3n.");
        ...
        if (rf & 2) {
          ...
          _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵtextInterpolate1"]("Situaci\xF3n en Espa\xF1a con ", _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵpipeBind1"](63, 30, ctx.jsonResumeSpain.Casos), " casos");
          ...
          _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵtextInterpolate1"]("Situaci\xF3n con ", _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵpipeBind1"](200, 42, ctx.comunidadSelecccionadaKPIS.casos), " casos");

          _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵadvance"](37);

          _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵtextInterpolate2"](" Ultima actualizaci\xF3n: (", ctx.jsonResumeSpain.Fecha, " - ", ctx.jsonResumeSpain.Hora, ") ");
        }
      },
      ...
      pipes: [_pipe_amount_pipe__WEBPACK_IMPORTED_MODULE_4__["Amount"]],
  ...
  /***/
  function srcAppPipeAmountPipeTs(module, __webpack_exports__, __webpack_require__) {
    "use strict";
    ...
    __webpack_require__.d(__webpack_exports__, "Amount", function () {
      return Amount;
    });
    /* harmony import */
    ...
    Amount.ɵfac = function Amount_Factory(t) {
      return new (t || Amount)();
    };

    Amount.ɵpipe = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdefinePipe"]({
      name: "amount",
      type: Amount,
      pure: true
    });
    ...
    (function () {
      _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵsetClassMetadata"](Amount, [{
