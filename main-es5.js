...
(window["webpackJsonp"] = window["webpackJsonp"] || []).push([["main"], {
  ...
  function srcAppComponentsCcaachartCcaachartComponentTs(module, __webpack_exports__, __webpack_require__) {
    ...
    function CCAAchartComponent_option_115_Template(rf, ctx) {
      if (rf & 1) {
    ...
    var CCAAchartComponent = /*#__PURE__*/function () {
      ...
      _createClass(CCAAchartComponent, [{
            ...
            var _loop = function _loop(i) {
              populationCSV.forEach(function (item_B) {
                if (data4.ccaa[i] === item_B.CCAA) {
                  ...
                  data4.acumulados[i] = relative.toFixed(2); //console.log(data4.ccaa[i], item_B.CCAA, data4.acumulados[i])
                }
              });
            };
            ...
            var _loop2 = function _loop2(_i) {
              populationCSV.forEach(function (item_B) {
                if (data5.ccaa[_i] === item_B.CCAA) {
                  ...
                  data5.ultimas[_i] = relative.toFixed(2); //console.log(data5.ccaa[i], item_B.CCAA, data5.ultimas[i])
                }
              });
            };
            ...
            var _loop3 = function _loop3(_i2) {
              populationCSV.forEach(function (item_B) {
                if (data6.ccaa[_i2] === item_B.CCAA) {
                  ...
                  data6.incidencia[_i2] = relative.toFixed(2); //console.log(data6.ccaa[i], item_B.CCAA, data6.incidencia[i])
                }
              });
            };
        ...
        value: function jsonReadyFull(data) {
          ...
          this.massageData("MD", "create"); //this.massageSpainData();
        }
      }, {
        ...
        value: function massageSpainData() {
          ...
          console.log("groupedByDate", groupedByDate.length, groupedByDate); //loop to calculate by Date
        ...
        value: function massageData(ccaacode, mode) {
          ...
          console.log("this.madridDataFull.", this.madridDataFull); //set KPIS de la comunidad
    ...
    CCAAchartComponent.ɵcmp = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdefineComponent"]({
      ...
      template: function CCAAchartComponent_Template(rf, ctx) {
        if (rf & 1) {
          ...
          _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵtext"](68, "Comparanci\xF3n de comunidades");
          ...
          _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵtext"](85, "Casos en los \xFAtimos 14 d\xEDas");
          ...
          _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵtext"](104, "Casos en los \xFAtimos 14 d\xEDas por cada 1000 habitantes");
          ...
          _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵlistener"]("ngModelChange", function CCAAchartComponent_Template_select_ngModelChange_114_listener($event) {
          ...
          _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵtext"](181, " Estas gr\xE1ficas siempre suben por que a cada d\xEDa se suman los datos del anterior");
          ...
          _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵtext"](188, "COVID 19: valores por d\xEDa ( ver nota **)");

          _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelementEnd"]();

          _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelementStart"](189, "p", 31);

          _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵtext"](190, " Estas gr\xE1ficas suben y bajan, por que son los casos totales de cada d\xEDa");

          _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelementEnd"]();

          _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelementStart"](191, "p", 31);

          _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵtext"](192, " Lo que hay que fijarse es si las columnas van bajando seg\xFAn pasan los d\xEDas, lo cual indicar\xEDa una mejora");
          ...
          _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵtext"](209, " estas gr\xE1ficas usan los datos oficiales compartidos por el gobierno a la poblaci\xF3n. Seg\xFAn el rigor con que se han tomado esos datos, las gr\xE1ficas por d\xEDas debe tomarse como una aproximaci\xF3n.");
        ...
        if (rf & 2) {
          ...
          _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵtextInterpolate1"]("Situaci\xF3n con ", _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵpipeBind1"](173, 42, ctx.comunidadSelecccionadaKPIS.casos), " casos");
